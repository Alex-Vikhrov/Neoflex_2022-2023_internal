...
import { employment, formContact } from "./initialValuesFormApplication";
...
const FormApplication: FC<{ isLoading: boolean, onSubmitFormApplication: any, }> = ({ isLoading, onSubmitFormApplication, }) => {
    ...
    const employmentArr = employment(values, touched, errors, handleBlur, handleChange, handleSubmit);
    const formContactArr = formContact(values, touched, errors, handleBlur, handleChange, handleSubmit);

    console.log(employmentArr);
    console.log(formContactArr);
    ...
    return (
        <CustomizeCard>
            <form className={isLoading ? "form-application load" : "form-application"} onSubmit={handleSubmit}>
                ...
                <FieldFormApplication initialValue={formContactArr} />
                <h3>Employment</h3>
                <FieldFormApplication initialValue={employmentArr} />
